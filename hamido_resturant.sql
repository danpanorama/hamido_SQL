...
CREATE TABLE `resturant` (
  `resturantid` int NOT NULL AUTO_INCREMENT,
  `name` varchar(25) DEFAULT NULL,
  `email` varchar(25) DEFAULT NULL,
  `address` varchar(55) DEFAULT NULL,
  `openhouers` varchar(25) DEFAULT NULL,
  `closehouers` varchar(25) DEFAULT NULL,
  `workday` varchar(25) DEFAULT NULL,
  `activeplace` tinyint DEFAULT NULL,
