...
CREATE TABLE `salads` (
  ...
  `simg` varchar(7005) DEFAULT NULL,
  `sactive` tinyint DEFAULT NULL,
  PRIMARY KEY (`sid`)
...
INSERT INTO `salads` VALUES (5,'חומוס','חומוס',0),(6,'טחינה','טחינה',0),(7,'חריף','חריף',0),(8,'צ\'ילי','צ\'ילי',0),(9,'עמבה','עמבה',0),(10,'קטשופ','קטשופ',0),(11,'מיונז','מיונז',0);
